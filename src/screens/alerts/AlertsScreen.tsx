            ...
            {events.map((event) => {
              ...
              return (
                <View key={event.id} style={{ flexDirection: 'row', gap: 12, alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 8, padding: 12, marginBottom: 8 }}>
                  ...
                  <View style={{ flex: 1 }}>
                    <Text style={{ fontSize: 13, fontWeight: '700', color: '#FFFFFF' }}>{event.title}</Text>
          ...
          notifications.map((notif) => {
            ...
            return (
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  <Text style={{ fontSize: 14, fontWeight: notif.is_read ? '600' : '800', color: colors.navy, marginBottom: 4 }}>
                    {notif.title}
                  </Text>
